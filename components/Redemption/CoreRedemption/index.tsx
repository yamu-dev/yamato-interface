...
function useYamatoStateForPledge(): { rateOfEthJpy: any; redemptionReserve: any; redeemableCandidate: any; GRR: any; firstLoadCompleted: any; } {
  // Add a return statement here
  return {
    rateOfEthJpy: null,
    redemptionReserve: null,
    redeemableCandidate: null,
    GRR: null,
