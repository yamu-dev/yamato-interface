function GitBook(props: any) {
  return (
    <svg
      ...
      className="r-1pa6394"
      style={{ verticalAlign: "middle", width: "28px", height: "28px" }}
      data-rnwi--njhh6i-hover-focus="true"
      data-rnwi-5xr8s6-dse9kg-1rbj2e8-2fw26j-focus-visible="true"
      {...props}
    >
      <path
        fill="#818181"
